...
1. [Releases](https://github.com/IronDiscipline-Project/IronDiscipline-dev/releases) から最新のJARファイルをダウンロードします。
...
`main` ブランチにプッシュされると、自動的に最新版がビルドされ、[Releases](https://github.com/IronDiscipline-Project/IronDiscipline-dev/releases) に公開されます。
